...
const deploy = { ...deployMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./deploy-ade73246.js'); }))
};
const prepare = { ...prepareMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./prepare-2683afc3.js'); }))
};
